...
> = {
  ...
  runFunction?: Resolver<
    Maybe<ResolversTypes['String']>,
    ParentType,
    ContextType,
    RequireFields<MutationRunFunctionArgs, 'functionPath'>
  >
  setValue?: Resolver<
    Maybe<ResolversTypes['atomicVariable']>,
    ParentType,
    ContextType,
    RequireFields<MutationSetValueArgs, 'value' | 'variablePath'>
  >
...
export type PlcResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes['Plc'] = ResolversParentTypes['Plc']
> = {
...
> = {
  ...
  metrics?: Resolver<
    Array<ResolversTypes['taskMetric']>,
    ParentType,
    ContextType
  >
  program?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryProgramArgs, 'name'>
  >
  ...
  tClass?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryTClassArgs, 'name'>
  >
  ...
  value?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<QueryValueArgs, 'variablePath'>
  >
  values?: Resolver<
    Array<ResolversTypes['atomicVariable']>,
    ParentType,
    ContextType
  >
  variables?: Resolver<
    Array<ResolversTypes['Variable']>,
    ParentType,
    ContextType
  >
}
...
> = {
  ...
  countdown?: SubscriptionResolver<
    ...
    ParentType,
    ContextType,
    RequireFields<SubscriptionCountdownArgs, 'from'>
  >
  runtimeUpdated?: SubscriptionResolver<
    ResolversTypes['Boolean'],
    'runtimeUpdated',
    ParentType,
    ContextType
  >
  taskMetrics?: SubscriptionResolver<
    Array<ResolversTypes['taskMetric']>,
    'taskMetrics',
    ParentType,
    ContextType
  >
  values?: SubscriptionResolver<
    Array<ResolversTypes['VariableValue']>,
    'values',
    ParentType,
    ContextType
  >
...
export type VariableResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['Variable'] = ResolversParentTypes['Variable']
> = {
  changeEvents?: Resolver<
    Maybe<ResolversTypes['eventTracker']>,
    ParentType,
    ContextType
  >
  children?: Resolver<
  ...
  >
  source?: Resolver<
    Maybe<ResolversTypes['VariableSource']>,
    ParentType,
    ContextType
  >
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>
...
export type VariableSourceResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['VariableSource'] = ResolversParentTypes['VariableSource']
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  params?: Resolver<
    Maybe<ResolversTypes['VariableSourceParams']>,
    ParentType,
    ContextType
  >
...
export type VariableSourceParamsResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['VariableSourceParams'] = ResolversParentTypes['VariableSourceParams']
> = {
...
export type VariableValueResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['VariableValue'] = ResolversParentTypes['VariableValue']
> = {
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type AtomicVariableResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['atomicVariable'] = ResolversParentTypes['atomicVariable']
> = {
  datatype?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ChangeResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['change'] = ResolversParentTypes['change']
> = {
...
export type ConfigModbusResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configModbus'] = ResolversParentTypes['configModbus']
> = {
  config?: Resolver<
    ResolversTypes['configModbusConfig'],
    ParentType,
    ContextType
  >
...
export type ConfigModbusConfigResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configModbusConfig'] = ResolversParentTypes['configModbusConfig']
> = {
  ...
  reverseBits?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType
  >
  reverseWords?: Resolver<
    Maybe<ResolversTypes['Boolean']>,
    ParentType,
    ContextType
  >
...
export type ConfigMqttResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configMqtt'] = ResolversParentTypes['configMqtt']
> = {
...
export type ConfigMqttConfigResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configMqttConfig'] = ResolversParentTypes['configMqttConfig']
> = {
...
export type ConfigOpcuaResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configOpcua'] = ResolversParentTypes['configOpcua']
> = {
  config?: Resolver<
    ResolversTypes['configOpcuaConfig'],
    ParentType,
    ContextType
  >
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type ConfigOpcuaConfigResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configOpcuaConfig'] = ResolversParentTypes['configOpcuaConfig']
> = {
  host?: Resolver<Maybe<ResolversTypes['String']>, ParentType, ContextType>
  port?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>
  retryRate?: Resolver<Maybe<ResolversTypes['Int']>, ParentType, ContextType>
...
export type ConfigTaskResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['configTask'] = ResolversParentTypes['configTask']
> = {
  description?: Resolver<ResolversTypes['String'], ParentType, ContextType>
  name?: Resolver<ResolversTypes['String'], ParentType, ContextType>
...
export type EventTrackerResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['eventTracker'] = ResolversParentTypes['eventTracker']
> = {
...
export type MemoryUsageResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['memoryUsage'] = ResolversParentTypes['memoryUsage']
> = {
...
export type TaskMetricResolvers<
  ContextType = any,
  ParentType extends
    ResolversParentTypes['taskMetric'] = ResolversParentTypes['taskMetric']
> = {
  functionExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
  intervalExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
  modbusExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
  mqttExecutionTime?: Resolver<ResolversTypes['Float'], ParentType, ContextType>
  opcuaExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
  overheadExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
  persistenceExecutionTime?: Resolver<
    ResolversTypes['Float'],
    ParentType,
    ContextType
  >
