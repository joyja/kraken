...
describe('Connection Manager', () => {
  ...
  describe('Connection Parameters', () => {
    ...
    it('Error-cases: owner', () => {
      const { build_connectionParameters, priority, fixedVar, connectionType } =
        manager
      expect(function () {
        build_connectionParameters(
          '1000',
    ...
    it('Error-cases: priority', () => {
      const { build_connectionParameters, owner, fixedVar, connectionType } =
        manager
      expect(function () {
        build_connectionParameters(
          owner['Exclusive'],
    ...
    it('Error-cases: fixedVar', () => {
      const { build_connectionParameters, owner, priority, connectionType } =
        manager
      expect(function () {
        build_connectionParameters(
          owner['Exclusive'],
