...
export async function createRoster(root: unknown, { input }: { input: CreateRoster }):Promise<Roster> {
	return await rosterHandler.create({ input })
}

export async function updateRoster(root: unknown, { input }: { input: UpdateRoster }):Promise<Roster> {
	return await rosterHandler.update({ input })
}

export async function deleteRoster(root: unknown, { input }: { input: DeleteRoster }):Promise<Roster> {
	return await rosterHandler.delete(input.id)
}

export async function createRosterEntry(root: unknown, { input }: { input: CreateRosterEntry }):Promise<RosterEntry> {
	return await rosterHandler.createEntry({ input })
}

export async function updateRosterEntry(root: unknown, { input }: { input: UpdateRosterEntry }):Promise<RosterEntry> {
	return await rosterHandler.updateEntry({ input })
}

export async function deleteRosterEntry(root: unknown, { input }: { input: DeleteRosterEntry }):Promise<RosterEntry> {
	return await rosterHandler.deleteEntry(input.id)
}

export async function moveUpRosterEntry(root: unknown, { input }: { input: MoveUpRosterEntry }):Promise<RosterEntry> {
...
export async function acknowledgeRoster(root: unknown, { id }: { id: string }):Promise<Roster> {
