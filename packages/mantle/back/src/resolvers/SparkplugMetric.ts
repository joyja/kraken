...
export function updatesLastMinute(parent: SparkplugMetric): number {
  return parent.updateEvents.inLastMinute()
}

export function updatesLastHour(parent: SparkplugMetric): number {
  return parent.updateEvents.inLastHour()
}

export function updatesLastDay(parent: SparkplugMetric): number {
  return parent.updateEvents.inLastDay()
}
