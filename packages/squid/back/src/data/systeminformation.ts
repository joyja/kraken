...
export class System extends MQTTData {
  constructor() {
    const metrics:MqttDataMetric[] = [{
        ...
        getter: async () => si.mem().then((data:any) => data.used / (1024 * 1024 * 1024)),
        type: 'Float'
      },{
        ...
        getter: async () => si.mem().then((data:any) => data.total / (1024 * 1024 * 1024)),
        type: 'Float'
      },{
        ...
        getter: async () => si.fsSize().then((data:any) => data[0].size / (1024 * 1024 * 1024)),
        type: 'Float'
      },{
        ...
        getter: async () => si.fsSize().then((data:any) => data[0].used / (1024 * 1024 * 1024)),
        type: 'Float'
    }]
    super(metrics)
  }
